...
Because the first line is the description about each column variables, we should skip 
the first line when importing csv dataset. In addition, sex and apoe4
