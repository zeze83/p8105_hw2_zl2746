...
of total litter and litter type. It also tells Mr.Transh transferred
3.1251667^{4} power into make electricity for Maryland homes.

The `Prof.Trash` data has 105 observations and 14 variables and tells us
about the information on the dumpter number, date of collection, amount
of total litter and litter type. It also tells Prof.Transh transferred
3570.1666667 power into make electricity.

The `G.Trash` data has 38 observations and 13 variables and tells us
about the information on the dumpter number, date of collection, amount
of total litter and litter type. It also tells Gwynnda Transh
transferred 1797.1666667 power into make electricity.
...
we should skip the first line when importing csv dataset. In addition,
sex and apoe4

There are 479 were recruited, and of \_\_ these develop MCI.
